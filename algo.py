...
api_key_id = "PKLQ761NFQFGXI505IMJ"
api_secret = "5LQWuw11H2F6khoT8sDDJV1mXUOV0sA365GvUiJQ"
...
def get_1000m_history_data(symbols):
    ...
    for symbol in symbols:
        minute_history[symbol] = api.get_aggs(timespan="minute", symbol=symbol, multiplier=1, _from="2020-09-16", to="2020-09-17").df
        c += 1
